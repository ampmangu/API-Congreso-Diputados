...
public interface VotacionRepository extends JpaRepository<Votacion, Long> {
    ...
    @Query(value = "select v.id as id, v.legislatura as legislatura, v.fecha as fecha, v.titulo as titulo, v.textoexpediente as textoexpediente from votacion v where v.textoexpediente like %:search% or v.titulo like %:search%", nativeQuery = true)
